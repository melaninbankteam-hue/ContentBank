...
import { X, Upload, Trash2, Download, Copy, Calendar, Clock, Image as ImageIcon, Edit } from "lucide-react";
...
const PostPlanningModal = ({ isOpen, onClose, selectedDate, currentMonth, monthlyData, setMonthlyData, onPostUpdate, editingPost }) => {
  ...
  const [selectedBrainstormIdea, setSelectedBrainstormIdea] = useState("");

  const selectBrainstormIdea = (ideaText) => {
    setSelectedBrainstormIdea(ideaText);
    toast({
      title: "Idea Selected!",
      description: "Brainstorm idea has been highlighted. Use it as inspiration for your caption.",
    });
  };
                      ...
                      <div className="flex justify-between items-start mb-2">
                        ...
                        <div className="flex gap-1">
                          <Button
                            ...
                            size="sm"
                            onClick={() => {
                              // Load the post data into the form for editing
                              const editingPost = { ...post, id: post.id };
                              setFormData({
                                type: post.type || "",
                              ...
                              toast({
                                ...
                                description: "Post data loaded for editing. Make your changes and save.",
                              });
                            }}
